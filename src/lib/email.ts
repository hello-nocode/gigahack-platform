...
export function passwordResetEmailHtml(link: string): string {
  return `<body style="background:#f9f9f9"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="background:#fff;max-width:600px;margin:auto;border-radius:10px"><tr><td align="center" style="padding:10px 0;font-size:22px;font-family:Helvetica,Arial,sans-serif;color:#444"><strong>Reset your password</strong></td></tr><tr><td style="padding:0 20px 10px;font-size:16px;line-height:22px;font-family:Helvetica,Arial,sans-serif;color:#444">We received a request to reset the password for your GigaHack account. Click the button below to choose a new password. This link expires in 1 hour. If you didn't request this, you can safely ignore this email.</td></tr><tr><td align="center" style="padding:20px 0"><table border="0" cellspacing="0" cellpadding="0"><tr><td align="center" style="border-radius:5px" bgcolor="#2563eb"><a href="${link}" target="_blank" style="font-size:16px;font-family:Helvetica,Arial,sans-serif;color:#fff;text-decoration:none;border-radius:5px;padding:10px 20px;border:1px solid #2563eb;display:inline-block;font-weight:bold;">Reset password</a></td></tr></table></td></tr><tr><td style="padding:0 20px 10px;font-size:13px;line-height:18px;font-family:Helvetica,Arial,sans-serif;color:#888">Or paste this link into your browser:<br/><a href="${link}" style="color:#2563eb">${link}</a></td></tr><tr><td align="center" style="padding:0 0 10px;font-size:13px;font-family:Helvetica,Arial,sans-serif;color:#888">Gigahack Platform</td></tr></table></body>`;
}
